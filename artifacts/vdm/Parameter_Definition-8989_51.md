...
| entity_file | .02 | Entity File | {::nomarkdown}This identifies an entity for which the parameter can be legally entered.  <br/>Entities are simply variable pointers.  The files which are eligible to be<br/>entities are listed in the PARAMETER ENTITY file.{:/} | POINTER |  | REQUIRED | Parameter_Entity-8989_518 | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 20th 2017, 4:59:48 am</p>{:/}