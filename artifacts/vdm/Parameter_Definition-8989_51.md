...
<dt>description</dt><dd>This file contains the characteristics of parameters.  Entries in this<br/>file must be namespaced and they are exported by the package which owns<br/>them.</dd>
</dl>
