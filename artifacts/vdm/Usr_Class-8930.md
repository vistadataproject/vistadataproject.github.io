...
| ok_to_distribute | 2 | Ok To Distribute | {::nomarkdown}Answer \YES\ if this individual User Class is to be distributed<br/>nationally.  Answer \NO\ if not.{:/} | BOOLEAN |  |  | {::nomarkdown}<dl><dt>0</dt><dd>false</dd><dt>1</dt><dd>true</dd></dl>{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 20th 2017, 4:59:48 am</p>{:/}