...
| status | .02 | Status | The Status of an NPI is either 'ACTIVE' or 'INACTIVE'. I 'ACTIVE' then \rthe NPI will be accessible by end-users to document a particular provider.\rIf 'INACTIVE', then the NPI will only be accessible by the application to\rdisplay legacy data. | ENUMERATION |  | REQUIRED | {::nomarkdown}<dl><dt>1</dt><dd>ACTIVE</dd><dt>0</dt><dd>INACTIVE</dd></dl>{:/} | 
...
| status | .04 | Status | The Status of a reference term is either 'ACTIVE' or 'INACTIVE', then the \rterm will be accessible by end-users to document a particular patient \revent. If 'INACTIVE', then the term will only be accessible by the \rapplication to display legacy data. | ENUMERATION |  |  | {::nomarkdown}<dl><dt>1</dt><dd>ACTIVE</dd><dt>0</dt><dd>INACTIVE</dd></dl>{:/} | 