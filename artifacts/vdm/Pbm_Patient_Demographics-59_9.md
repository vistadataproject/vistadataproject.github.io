...
<dt>description</dt><dd>{::nomarkdown}This file captures the date, time, and PATIENT DFN when any change occurs <br/>in the PATIENT file (#2) on any field captured in the PBM Patient <br/>Demographics Extract. Data in this file will be purged monthly for data <br/>older than 75 days.{:/}</dd>
</dl>
