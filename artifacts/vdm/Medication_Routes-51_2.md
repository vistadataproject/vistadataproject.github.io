...
| new_value | 3 | New Value | {::nomarkdown}This is the new value of the STANDARD MEDICATION ROUTE (#10) Field when a<br/>change is made. It can be null, if there is no new value. It is set from<br/>the PSSMEDX routine, which is invoked from the new style cross reference<br/>of the STANDARD MEDICATION ROUTE (#10) Field of the MEDICATION ROUTES<br/>(#51.2) File.{:/} | POINTER |  |  | Standard_Medication_Routes-51_23 | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 19th 2017, 7:54:22 am</p>{:/}