...
| assessment_date_time | 3 | Assessment Date/time | {::nomarkdown}This field contains the date/time of the last reaction assessment for<br/>this patient.{:/} | DATE-TIME |  |  |  | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 15th 2017, 12:59:58 am</p>{:/}