...
| scope | 3 | Scope | Scope - Demonstrates the relationship of the term to the Major Concept.\rMajor Concepts, Synonyms to Major Concepts and Lexical Variants to a Major\rConcept are (D)irectly linked.  Lexical Variants to a Synonym of a Major\rConcept are (I)ndirectly linked.  Related concepts are either (B)roader in\rscope, (N)arrower in scope, or an (O)ther/undefined view of the Major\rConcept. | ENUMERATION |  | REQUIRED | <dl><dt>B</dt><dd>BROADER VIEW</dd><dt>D</dt><dd>DIRECTLY LINKED</dd><dt>I</dt><dd>INDIRECTLY LINKED</dd><dt>R</dt><dd>RELATED VIEW</dd><dt>N</dt><dd>NARROWER VIEW</dd><dt>O</dt><dd>OTHER</dd><dt>C</dt><dd>CONTROLLED VIEW</dd></dl> | 
...
| deactivation_flag | 9 | Deactivation Flag | This field indicates that a term formerly in use by the Lexicon has\rbeen deactivated and should not be used in lookups or displays. | ENUMERATION |  |  | <dl><dt>0</dt><dd>ACTIVE</dd><dt>1</dt><dd>DEACTIVATED</dd></dl> | 
...
| modifier_type | 11 | Modifier Type | Flag indicated where the modifier is to be placed 1) at the begining of the\rdisplay text and 2) at the end of the display text. | ENUMERATION |  |  | <dl><dt>1</dt><dd>MODIFIER (BEGINING OF TEXT)</dd><dt>2</dt><dd>SPECIFIER (ENDING OF TEXT)</dd><dt>0</dt><dd>UNMODIFIED</dd></dl> | 
...
| parent | 13 | Parent | This is the internal entry number in the Expression file #757.01 where the\rparent of a descendant term is located.  Only descendant terms have parents. | POINTER |  | INDEXED | {id:Expressions-757_01} | 
