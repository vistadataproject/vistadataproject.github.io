...
| hierarchy | 2 | Hierarchy | {::nomarkdown}This is the SNOMED CT Hierarchy that the concept belongs to.{:/} | POINTER |  |  | Snomed_Ct_Hierarchy-757_018 | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 19th 2017, 7:54:21 am</p>{:/}