...
| mnemonic | 8801 | Mnemonic | {::nomarkdown}(Optional)<br/>This is a mnemonic for this treatment.<br/> <br/>Enter a mnemonic that's 1 - 6 characters in length.{:/} | STRING |  |  |  | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 20th 2017, 4:59:48 am</p>{:/}