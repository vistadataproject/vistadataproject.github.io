...
<dt>description</dt><dd>This file contains a descriptive name of health factors, and their health<br/>factor category.<br/> <br/>Changes to this data dictionary should be coordinated thru the IHS DBA.</dd>
</dl>
