...
| --- | --- | --- | --- | --- | --- | --- | --- | 
| problem | .01 | Problem | This is the problem for which a change is being recorded. | POINTER |  | REQUIRED, INDEXED | {id:Problem-9000011} | 
...
| who_modified | 3 | Who Modified | This is the user who actually made the change to this data; the current\ruser's DUZ is stuffed in here. | POINTER |  |  | {id:New_Person-200} | 
...
| requesting_provider | 7 | Requesting Provider | This is the provider who either changed this data, or directed it to be\rchanged. | POINTER |  |  | {id:New_Person-200} | 
