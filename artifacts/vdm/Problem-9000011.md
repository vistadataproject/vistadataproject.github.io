...
| facility | .06 | Facility | {::nomarkdown}This is the facility at which this problem was originally observed and<br/>documented.{:/} | POINTER |  | REQUIRED | [Location-9999999_06](Location-9999999_06.md) | 
...
| id | fmId | label | description | datatype | location | attributes | range | 
| --- | --- | --- | --- | --- | --- | --- | --- | 
| note_facility | .01 | Note Facility | {::nomarkdown}This is the location at which the notes in this multiple originated.{:/} | POINTER |  | REQUIRED, INDEXED | [Location-9999999_06](Location-9999999_06.md) | 
...
| code_date | .03 | Code Date | {::nomarkdown}This is the date when the code and coding system were filed. This allows <br/>proper resolution of the code, irrespective of code set versions, etc.{:/} | DATE-TIME |  |  |  | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 20th 2017, 4:59:48 am</p>{:/}