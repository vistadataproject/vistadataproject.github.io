...
| code_date | .03 | Code Date | {::nomarkdown}This is the date when the code and coding system were filed. This allows <br/>proper resolution of the code, irrespective of code set versions, etc.{:/} | DATE-TIME |  |  |  | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 15th 2017, 12:59:58 am</p>{:/}