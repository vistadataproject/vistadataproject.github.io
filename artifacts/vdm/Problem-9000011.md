...
| facility | .06 | Facility | {::nomarkdown}This is the facility at which this problem was originally observed and<br/>documented.{:/} | POINTER |  | REQUIRED | {id:Location-9999999_06} | 
...
| id | fmId | label | description | datatype | location | attributes | range | 
| --- | --- | --- | --- | --- | --- | --- | --- | 
| note_facility | .01 | Note Facility | {::nomarkdown}This is the location at which the notes in this multiple originated.{:/} | POINTER |  | REQUIRED, INDEXED | {id:Location-9999999_06} | 
