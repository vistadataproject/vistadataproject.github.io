...
| --- | --- | --- | --- | --- | --- | --- | --- | 
| name | .01 | Name | {::nomarkdown}This field points to the Institution file (#4) and has the same internal<br/>number as that file.  Thus, the location has the same name as the<br/>Institution file (#4).  The location is also referred to as the Facility.{:/} | POINTER |  | REQUIRED, INDEXED | [Institution-4](Institution-4.md) | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 20th 2017, 4:59:48 am</p>{:/}