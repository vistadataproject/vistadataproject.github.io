...
| parent | .06 | Parent | {::nomarkdown}In the event that the current report is an addendum or replacement, or is<br/>a component of a report, this field points to the original report.{:/} | POINTER |  | INDEXED | TIU_Document-8925 | 
...
| retracted_original | 1406 | Retracted Original | {::nomarkdown}This self-refering pointer identifies the original document which was <br/>retracted in error to produce this record.{:/} | POINTER |  |  | TIU_Document-8925 | 
