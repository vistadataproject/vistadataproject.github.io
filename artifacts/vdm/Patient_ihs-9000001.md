...
| record_status | .05 | Record Status | This field is used by the IHS Multi-Facility Integration (MFI) package\rto determine whether to stop integrating data at a facility for a \rparticular patient and location facility. | ENUMERATION |  |  | {::nomarkdown}<dl><dt>D</dt><dd>DELETED</dd><dt>I</dt><dd>INACTIVATED</dd><dt>M</dt><dd>MERGED</dd></dl>{:/} | 
