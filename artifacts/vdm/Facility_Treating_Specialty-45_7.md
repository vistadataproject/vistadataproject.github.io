...
<dt>description</dt><dd>{::nomarkdown}This file is used to maintain the various teams of specialties that are used to treat a patient during his episodes of care.<br/>A change in the bedsection associated with the treating specialties causes<br/>the generation of changes in bedsection for PTF purposes.<br/>the generation of changes in bedsection for PTF purposes.{:/}</dd>
</dl>
