...
| observed_historical | 6 | Observed/historical | Indicates whether this allergy/adverse reaction has been observed by some\rpersonnel, or if it is historical data gathered about the patient. | ENUMERATION |  | REQUIRED | {::nomarkdown}<dl><dt>o</dt><dd>OBSERVED</dd><dt>h</dt><dd>HISTORICAL</dd></dl>{:/} | 
...
| mechanism | 17 | Mechanism | This field indicates the mechanism of the reaction.\r   | ENUMERATION |  |  | {::nomarkdown}<dl><dt>P</dt><dd>PHARMACOLOGIC</dd><dt>U</dt><dd>UNKNOWN</dd><dt>A</dt><dd>ALLERGY</dd></dl>{:/} | 
