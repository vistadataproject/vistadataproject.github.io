...
<dt>description</dt><dd>This file contains the order checks which are used within OE/RR-CPRS to<br/>perform real-time order checking within the OE/RR-CPRS ordering dialogs.</dd>
</dl>
