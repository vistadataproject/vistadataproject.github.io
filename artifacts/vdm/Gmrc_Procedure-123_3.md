...
| ifc_coordinator | 129 | Ifc Coordinator | {::nomarkdown}The person entered in this field will have expanded abilities to correct <br/>IFC records that require manual intervention to remain updated.<br/> <br/>The full capabilities of this field are not yet defined.{:/} | POINTER |  |  | [New_Person-200](New_Person-200.md) | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 20th 2017, 4:59:48 am</p>{:/}