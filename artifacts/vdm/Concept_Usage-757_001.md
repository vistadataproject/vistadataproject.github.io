...
<dt>description</dt><dd>{::nomarkdown}This file records the usage of concepts by applications performing lookups<br/>using the Special Lookup Routines provided with the Lexicon Utility.  A listing<br/>of concept usage in decending order may be found at the \AF\ index.{:/}</dd>
</dl>{:/}
