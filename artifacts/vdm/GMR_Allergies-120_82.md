...
| drug_ingredients | 4 | Drug Ingredients | {::nomarkdown}List of drug ingredients that comprise this particular allergy.{:/} | [POINTER] |  |  | [Drug_Ingredients-50_416](Drug_Ingredients-50_416.md) | 
| va_drug_classes | 5 | VA Drug Classes | {::nomarkdown}List of VA Drug classes that comprise this reactant.{:/} | [POINTER] |  |  | [VA_Drug_Class-50_605](VA_Drug_Class-50_605.md) | 
...
| status | .02 | Status | {::nomarkdown}The Status of a reference term is either 'ACTIVE' or 'INACTIVE'.  If<br/>'ACTIVE', then the term will be accessible by end-users to<br/>document a particular patient event.  If 'INACTIVE', then the term<br/>will only be accessible by the application to display legacy data.{:/} | ENUMERATION |  | REQUIRED | {::nomarkdown}<dl><dt>1</dt><dd>ACTIVE</dd><dt>0</dt><dd>INACTIVE</dd></dl>{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 15th 2017, 12:59:58 am</p>{:/}