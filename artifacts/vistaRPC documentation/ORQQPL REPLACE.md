...
## MUMPS Method description
 ...
 Code | ```  N CHNGE,DIE,DR<br/> I $P($G(^AUPNPROB(DA,1)),U,2)'="H" D  Q  ; BAIL OUT - INVALID RECORD<br/> . S RETURN=0<br/> S DR="1.02////P"<br/> S DIE="^AUPNPROB("<br/> D ^DIE<br/> S CHNGE=DA_"^1.02^"_$$HTFM^XLFDT($H)_U_DUZ_"^H^P^Replaced^"_DUZ<br/> D AUDIT^GMPLX(CHNGE,"")<br/> D DTMOD^GMPLX(DA)<br/> S RETURN=1```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}