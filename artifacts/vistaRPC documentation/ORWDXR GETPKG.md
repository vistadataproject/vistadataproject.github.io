...
## MUMPS Method description
 ...
 Code | ```  N ORDERID,PKGID<br/> Q:+IFN<1<br/> S ORDERID=+IFN,Y=""<br/> S PKGID=$P(^OR(100,ORDERID,0),U,14)<br/> S:PKGID>0 Y=$P(^DIC(9.4,PKGID,0),U,2)```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}