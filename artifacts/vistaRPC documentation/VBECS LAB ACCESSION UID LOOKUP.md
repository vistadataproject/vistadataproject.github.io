...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}VBLRO{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}20{:/} | {::nomarkdown}true{:/} | {::nomarkdown}Input VBLRO = The Lab Order number received in Blood Bank with an orderfrom CPRS. {:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}