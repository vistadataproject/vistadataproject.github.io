...
# [RPCs](TableOfContent.md) &#8594; DSIV DDR FILER 
 ...
 property | value 
--- | --- 
 label | {::nomarkdown}DSIV DDR FILER{:/}
 tag | {::nomarkdown}FILE{:/}
...
| {::nomarkdown}DATA{:/} | {::nomarkdown}LIST{:/} | {::nomarkdown}250{:/} | {::nomarkdown}true{:/} | {::nomarkdown} This is an array of fields in format:  DATA(field_num)=value{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}