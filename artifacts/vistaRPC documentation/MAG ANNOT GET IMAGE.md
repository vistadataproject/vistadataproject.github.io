...
## [VISTA RPCs](TableOfContent.md) &#8594; MAG ANNOT GET IMAGE 

 property | value 
--- | --- 
 label | MAG ANNOT GET IMAGE
 tag | GET
...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | IEN | LITERAL | 30 | true | IMAGE file (#2005) internal entry number | 