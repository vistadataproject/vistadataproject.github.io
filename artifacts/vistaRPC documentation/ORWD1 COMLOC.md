...
## MUMPS Method description
 ...
 Code | ```  N I<br/> S LOC=0,I=0<br/> F  S I=$O(ORDERS(I)) Q:'I  D  Q:LOC<br/> . I $P(ORDERS(I),U,2)'["R",($P(ORDERS(I),U,2)'["S") Q<br/> . S LOC=+$P($G(^OR(100,+ORDERS(I),0)),U,10)<br/> I LOC F  S I=$O(ORDERS(I)) Q:'I  D  Q:'LOC<br/> . I $P(ORDERS(I),U,2)'["R",($P(ORDERS(I),U,2)'["S") Q<br/> . I (+$P($G(^OR(100,+ORDERS(I),0)),U,10)'=LOC) S LOC=0```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}