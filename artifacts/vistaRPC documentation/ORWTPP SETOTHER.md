...
# [RPCs](TableOfContent.md) &#8594; ORWTPP SETOTHER 
 ...
 property | value 
--- | --- 
 label | {::nomarkdown}ORWTPP SETOTHER{:/}
 tag | {::nomarkdown}SETOTHER{:/}
...
## MUMPS Method description
 ...
 Code | ```  D SETOTHER^ORWTPO(.OK,INFO,DUZ)```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}