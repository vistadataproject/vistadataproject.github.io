...
## [VISTA RPCs](TableOfContent.md) &#8594; MAGV RAD EXAM REGISTER 

 property | value 
--- | --- 
 label | MAGV RAD EXAM REGISTER
 tag | XMREGSTR
 routine | [MAGVIM05](http://code.osehra.org/dox/Routine_MAGVIM05_source.html)
 return value type | ARRAY
 description | Wraps a call to the RAMAG EXAM REGISTER remote procedure, and re-formatsthe output for the DICOM Importer II application. Returns the IEN ofthe new case in the RAD/NUC MED PATIENT file (#70), or an arrayof error messages.
