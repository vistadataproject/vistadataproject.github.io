...
## [VISTA RPCs](TableOfContent.md) &#8594; ORQQPXRM REMINDER INQUIRY 

 property | value 
--- | --- 
 label | {::nomarkdown}ORQQPXRM REMINDER INQUIRY{:/}
 tag | {::nomarkdown}RES{:/}
...
### Method description
 ...
 Leading comment lines | {::nomarkdown}ORQQPXRM REMINDER WEB{:/}
