...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | DATA | LIST |  | true | DATA - ARRAY - This will be a multiple value parameter.  The values in order will be as follows:   1. Address File Internal Number (Null if new OR Numeric)  2. Patient - Internal Number (\441;DPT(,\)  3. Street Address Line One - Text 35 character max  4. Street Address Line Two - Text 35 character max  5. Street Address Line Three - Text 35 character max  6. City - Text 40 character max  7. State - Internal Number - Numeric (ie. 36 for NY)  8. Zip Code - Numeric 5 or 9 numbers  9. Address Holder - Code ; Description     (Patient/Unregistered Patient/Requestor - P/N/R) 10. Holder - Internal Number ; File Reference\      (Patient, Unregistered Patient, or Requestor IEN)     (\441;DPT(,\/\6;DSIR(19620.96,\/\36;DSIR(19620.12,\) 11. Inactive flag (1=INACTIVE 12. Phone 13. Fax | 