...
## MUMPS Method description
 ...
 Code | ```  N ORDATA<br/> D ENT^YSGAFAP1(.ORDATA,.ORINPUT)<br/> S ORY=($G(ORDATA(1))="[DATA]")```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}