...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | FRDATE | LITERAL | 7 | true | Date to begin pulling data in FileMan format with no time. | 
| vs:Input_Parameter-8994_02 | TODATE | LITERAL | 7 | true | FileMan date to end retrieval process. | 
...
| vs:Input_Parameter-8994_02 | TYPS | LIST | 99 | true | This is an array of internal numbers to file 19620.61 DSIR TYPE OFREQUEST.  It is used for reporting criteria if no types are specifiedthen all types will be included in the report. | 
...
| vs:Input_Parameter-8994_02 | ESTART | LITERAL | 14 | true | Earliest time to start the scheduled task.  Mmust be inFileMan date/timeformat. | 