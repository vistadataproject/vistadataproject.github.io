...
## MUMPS Method description
 ...
 Code | ```  N I,X<br/> S VAL=0<br/> S X=$O(^ORD(101.44,IEN,20,"C",FROM))<br/> I '$L(X) Q<br/> S I=$O(^ORD(101.44,IEN,20,"C",X,0))<br/> Q:'I<br/> S VAL=+I_U_X```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}