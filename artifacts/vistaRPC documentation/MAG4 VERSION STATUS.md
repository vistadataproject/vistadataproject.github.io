...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}MAGVER{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}100{:/} | {::nomarkdown}true{:/} | {::nomarkdown}The Imaging Version to be checked.  In the format   MAG*3.0*59   or   3.0.59{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}