...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | DFN | LITERAL | 30 | true | The value of this parameter is a pointer to ^DPT().This pointer identifies the patient for whom informationis being requested. | 