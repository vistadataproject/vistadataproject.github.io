...
# [RPCs](TableOfContent.md) &#8594; DVBA CAPRI GETCLAIMTYPE 
...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}REQIEN{:/} | {::nomarkdown}LITERAL{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown}This is the valid 2507 Request IEN{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}