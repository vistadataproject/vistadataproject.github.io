...
# [RPCs](TableOfContent.md) &#8594; TIU MED LIST ALL 
...
| {::nomarkdown}TIUDIR{:/} | {::nomarkdown}LITERAL{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown}Boolean value for list direction.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}