...
## [RPCs](TableOfContent.md) &#8594; ORWTPP TEAMS 
...
### MUMPS Method description
 ...
 Method comment | RPC
 First comment | {::nomarkdown}<pre> get teams for current user</pre>{:/}
 Code | {::nomarkdown}  D TEAMS^ORWTPT(.VALUES,DUZ){:/}
