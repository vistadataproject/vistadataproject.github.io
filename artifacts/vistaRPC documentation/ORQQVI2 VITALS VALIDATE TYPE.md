...
## [VISTA RPCs](TableOfContent.md) &#8594; ORQQVI2 VITALS VALIDATE TYPE 
 ...
 property | value 
--- | --- 
 label | {::nomarkdown}ORQQVI2 VITALS VALIDATE TYPE{:/}
 tag | {::nomarkdown}VMTYPES{:/}
...
### Method description
 ...
 property | value 
 --- | --- 
 Leading comment lines | {::nomarkdown}This function returns one if ORQTYPE is a valid type abbrev.
