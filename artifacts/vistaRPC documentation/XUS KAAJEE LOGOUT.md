...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}SIGNON-LOG-DA{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}1{:/} | {::nomarkdown}true{:/} | {::nomarkdown}The DA (IEN) of the user's signon log entry.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}