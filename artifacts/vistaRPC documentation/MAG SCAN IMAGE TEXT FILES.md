...
# [RPCs](TableOfContent.md) &#8594; MAG SCAN IMAGE TEXT FILES 
...
| {::nomarkdown}DIR{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}5{:/} | {::nomarkdown}true{:/} | {::nomarkdown}The value of this parameter is a number. If the value of this numberis less than zero, the value -1 will be used. Otherwise, the value1 will be used. The value of this parameter is used in references to $ORDER to traversethe IMAGE file (#2005){:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}