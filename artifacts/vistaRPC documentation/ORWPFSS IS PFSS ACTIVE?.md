...
## MUMPS Method description
 ...
 Code | ```  S ORY=+$$PATCH^XPDUTL("IB*2.0*286") Q:ORY=0<br/> S ORY=+$$SWSTAT^IBBAPI()  ;IA #4663```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}