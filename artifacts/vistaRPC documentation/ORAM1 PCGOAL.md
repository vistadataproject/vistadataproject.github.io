...
| {::nomarkdown}CMPLX{:/} | {::nomarkdown}LITERAL{:/} |  |  | {::nomarkdown}OPTIONAL,  IF MISSING, CLACULATES ON ALL VISITS; IF 1 ONLY CALCULATES ON NON-COMPLX VISITS{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}