...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | LOCATION | LITERAL | 20 | true | The value of this parameter is a pointer to ^DIC(4).This pointer identifies the location for which images are beingtransmitted. | 