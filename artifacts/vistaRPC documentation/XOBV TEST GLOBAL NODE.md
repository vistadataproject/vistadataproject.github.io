...
# [RPCs](TableOfContent.md) &#8594; XOBV TEST GLOBAL NODE 
...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}STRING{:/} | {::nomarkdown}LITERAL{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown}A single string of information.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}