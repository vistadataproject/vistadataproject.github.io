...
# [RPCs](TableOfContent.md) &#8594; KMPD ROUTINE SAVE 
...
| {::nomarkdown}PARAM2{:/} | {::nomarkdown}LIST{:/} | {::nomarkdown}240{:/} | {::nomarkdown}true{:/} | {::nomarkdown}Array containing routine code.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}