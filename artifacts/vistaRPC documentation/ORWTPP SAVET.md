...
### MUMPS Method description
 ...
 Method comment | RPC
 Input parameters | {::nomarkdown}CLASS, DEFAULT, VALUES{:/}
 First comment | {::nomarkdown}<pre> save titles for current user</pre>{:/}
 Code | {::nomarkdown}  D SAVET^ORWTPN(.OK,CLASS,DEFAULT,.VALUES,DUZ){:/}
