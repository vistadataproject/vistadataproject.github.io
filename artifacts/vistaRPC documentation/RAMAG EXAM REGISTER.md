...
## [VISTA RPCs](TableOfContent.md) &#8594; RAMAG EXAM REGISTER 

 property | value 
--- | --- 
 label | RAMAG EXAM REGISTER
 tag | REGISTER
 routine | [RAMAGRP1](http://code.osehra.org/dox/Routine_RAMAGRP1_source.html)
 return value type | ARRAY
 description | The RAMAG EXAM REGISTER remote procedure registers the exam and returnsidentifiers of the new case(s) in the RAD/NUC MED PATIENT file (#70). Italso sends all required notifications.
