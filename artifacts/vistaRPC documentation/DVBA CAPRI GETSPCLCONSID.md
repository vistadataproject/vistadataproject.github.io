...
# [RPCs](TableOfContent.md) &#8594; DVBA CAPRI GETSPCLCONSID 
...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}2507 REQUEST IEN{:/} | {::nomarkdown}LITERAL{:/} |  | {::nomarkdown}true{:/} |  | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}