...
## MUMPS Method description
 ...
 Code | ```  N I<br/> S I=0,REQ=0<br/> F  S I=$O(ORDERS(I)) Q:'I  D  Q:REQ<br/> . I +$P($G(^OR(100,+ORDERS(I),0)),U,16) S REQ=1```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}