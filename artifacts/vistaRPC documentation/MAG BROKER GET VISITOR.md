...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}MAGTKN{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}256{:/} | {::nomarkdown}true{:/} | {::nomarkdown}The Broker Security Enhancement (BSE) token to validate.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}