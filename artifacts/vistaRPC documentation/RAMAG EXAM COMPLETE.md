...
## [VISTA RPCs](TableOfContent.md) &#8594; RAMAG EXAM COMPLETE 

 property | value 
--- | --- 
 label | RAMAG EXAM COMPLETE
 tag | COMPLETE
 routine | [RAMAGRP1](http://code.osehra.org/dox/Routine_RAMAGRP1_source.html)
 return value type | ARRAY
 description | The RAMAG EXAM COMPLETE remote procedure completes the exam. It also sendsrequired HL7 messages, sends changed order control \XX\ to CPRS, but doesnot send VistA alerts regarding the exam status change.
