...
## MUMPS Method description
 ...
 Code | ```  Q:$G(A7RNDBI)  ; per NDBI, to suppress prints during integration<br/> N TMPLST,I,J<br/> S HLOC=+HLOC_";SC(",OK=1<br/> S I="",J=0 F  S I=$O(PRTLST(I)) Q:I'>0  D<br/> . I ($L(PRTLST(I),U)>1),'$P(PRTLST(I),U,5) Q<br/> . S J=J+1,TMPLST(J)=$P(PRTLST(I),U)<br/> I $D(TMPLST)>1 D GUI^ORPR02(.TMPLST,"","S",HLOC)<br/>```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}