...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | DATA | LITERAL | 10 | true | Format:  data = p1 ^ p2  where  p1 = cpt code name (or ien to file 81)  p2 = optional - if p2=1 then add cpt code to file 228       if p2 is undefined or is 0, then lookup ien to file 228,       but do not add if cpt is not in file 228 | 
