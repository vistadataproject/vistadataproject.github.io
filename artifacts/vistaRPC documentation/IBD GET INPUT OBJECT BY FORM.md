...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}FRM{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}40{:/} | {::nomarkdown}true{:/} | {::nomarkdown}Input the pointer to the encounter form file or the unique name of theencounter form{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}