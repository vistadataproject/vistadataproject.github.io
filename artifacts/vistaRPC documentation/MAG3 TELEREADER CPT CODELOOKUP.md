...
## [VISTA RPCs](TableOfContent.md) &#8594; MAG3 TELEREADER CPT CODELOOKUP 

 property | value 
--- | --- 
 label | MAG3 TELEREADER CPT CODELOOKUP
 tag | CPTFIND
...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | MAGFIND | LITERAL |  | true | Look up CPT code description value. | 