...
| vs:Input_Parameter-8994_02 | MESSAGE | LITERAL | 30 | true | The value of this parameter is a text-string.This text value identifies the rubric for which a count isto be incremented. | 