...
### MUMPS Method description
 ...
 Input parameters | {::nomarkdown}RSPID, TRANS{:/}
 First comment | {::nomarkdown}<pre> RSPID:  C123456;1-3243 = cached copy,   134-3234 = cached quick<br/>         X123456;1      = change order,  134      = quick dialog</pre>{:/}
