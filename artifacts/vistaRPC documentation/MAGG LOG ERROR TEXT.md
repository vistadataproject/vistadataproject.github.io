...
# [RPCs](TableOfContent.md) &#8594; MAGG LOG ERROR TEXT 
...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}TEXT{:/} | {::nomarkdown}LIST{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown}This is the list of text to insert.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}