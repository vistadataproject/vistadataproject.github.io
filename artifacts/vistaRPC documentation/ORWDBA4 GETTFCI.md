...
## MUMPS Method description
 ...
 Code | ```  N AI,CI,CNT,DXS,TF,TFCI<br/> S U="^",(CNT,TF)=""<br/> F  S CNT=$O(ORIEN(CNT)) Q:CNT=""  D<br/> . S TF=$$GTF(ORIEN(CNT))<br/> . S DXS=$$GDCD(ORIEN(CNT))<br/> . I TF="NNNNNNNN"&(DXS="") Q<br/> . S TFCI(CNT)=ORIEN(CNT)_U_TF_$S(DXS="":"",1:U_DXS)<br/> M Y=TFCI```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}