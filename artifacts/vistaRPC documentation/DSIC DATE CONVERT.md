...
## [VISTA RPCs](TableOfContent.md) &#8594; DSIC DATE CONVERT 

 property | value 
--- | --- 
 label | DSIC DATE CONVERT
 tag | CNVT
 routine | [DSICDT](http://code.osehra.org/dox/Routine_DSICDT_source.html)
 return value type | SINGLE VALUE
 description | This will take a date in any format and convert it to any other format.
