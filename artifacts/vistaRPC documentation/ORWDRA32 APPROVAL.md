...
## MUMPS Method description
 ...
 Code | ```  N ORX,I<br/> S I="" F  S I=$O(^VA(200,"ARC","S",I)) Q:I=""  D<br/> . ;I $P($G(^VA(200,I,"PS")),U,4),$P(^VA(200,I,"PS"),U,4)'>DT Q<br/> . I '$$ACTIVE^XUSER(I) Q<br/> . I $P($G(^VA(200,I,"RA")),U,3),$P(^VA(200,I,"RA"),U,3)'>DT Q<br/> . S ORX=$P($G(^VA(200,I,0)),U)<br/> . S Y(I)=I_U_ORX```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}