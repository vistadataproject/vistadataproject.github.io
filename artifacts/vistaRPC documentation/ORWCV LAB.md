...
## MUMPS Method description
 ...
 Code | ```  D:$L($T(STRT2^AWCMCPR1)) STRT2^AWCMCPR1<br/> D LIST^ORQOR1(.LST,DFN,"LAB",4,"T-"_$$RNGLAB(DFN),"T","AW",1)<br/> D:$L($T(END^AWCMCPR1)) END^AWCMCPR1```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}