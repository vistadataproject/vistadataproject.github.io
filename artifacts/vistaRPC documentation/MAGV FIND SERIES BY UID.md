...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}SERUID{:/} | {::nomarkdown}LITERAL{:/} |  |  | {::nomarkdown}The SERIES UID used to look up the series.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}