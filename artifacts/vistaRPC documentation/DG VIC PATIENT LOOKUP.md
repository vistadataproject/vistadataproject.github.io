...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}DPTX{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}255{:/} | {::nomarkdown}true{:/} | {::nomarkdown}This should be the entire input from either the Magnetic Strip or theBarcode.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}