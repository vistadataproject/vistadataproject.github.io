...
# [RPCs](TableOfContent.md) &#8594; DSIR GET REPORT LIST 
...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}RNAME{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}30{:/} | {::nomarkdown}true{:/} | {::nomarkdown}RNAME - (OPTIONAL) REPORT NAME FOR A SPECIFIC REPORT{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}