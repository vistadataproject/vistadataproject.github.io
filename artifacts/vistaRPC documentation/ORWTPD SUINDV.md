...
## MUMPS Method description
 ...
 Code | ```  I $L(RPTS)=0 Q<br/> N ORERR,RPTID,P1,P7 S ORERR=0<br/> S (P1,P7)=""<br/> F I=1:1:$L(RPTS,"^") S RPTID=$P(RPTS,U,I) D<br/> . S P1=$P($G(^ORD(101.24,RPTID,0)),U),P7=$P($G(^(0)),U,7)<br/> . I "02345"[P7,(P1'="ORRP IMAGING") D DEL^XPAR("USR.`"_DUZ,"ORWRP TIME/OCC LIMITS INDV",RPTID,.ORERR) Q<br/> . D EN^XPAR(DUZ_";VA(200,","ORWRP TIME/OCC LIMITS INDV",RPTID,VALUE,.ORERR)```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}