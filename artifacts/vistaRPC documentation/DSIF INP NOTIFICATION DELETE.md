...
# [RPCs](TableOfContent.md) &#8594; DSIF INP NOTIFICATION DELETE 
...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}NOTEIEN{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}20{:/} | {::nomarkdown}true{:/} |  | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}