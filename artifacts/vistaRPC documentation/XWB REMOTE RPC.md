...
## MUMPS Method description
 ...
 Code | ```  N I,INX,N,PMAX,RPCIEN,X,XWBDVER,XWBESSO,XWBHDL,XWBHL7,XWBMSG<br/> N XWBPAR,XWBPCNT,XWBSEC,ZTDESC,ZTDTH,ZTIO,ZTRTN,ZTSAVE,ZTSK<br/> D SETUP(1) I $G(RET(1))'="" QUIT  ;-><br/> S ZTSAVE("*")="",ZTRTN="DEQ^XWB2HL7C",ZTDTH=$H,ZTIO=""<br/> S ZTDESC="RPC Broker queued call from EN1~XWB2HL7"<br/> D ^%ZTLOAD<br/> I $G(ZTSK)'>0 S RET(0)="-1^Failed to task" QUIT  ;-><br/> S RET(0)=XWBHDL<br/> D SETNODE^XWBDRPC(XWBHDL,"TASK",ZTSK)```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}