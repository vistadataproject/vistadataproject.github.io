...
# [RPCs](TableOfContent.md) &#8594; ORWTPP GETTD 
 ...
 property | value 
--- | --- 
 label | {::nomarkdown}ORWTPP GETTD{:/}
 tag | {::nomarkdown}GETTD{:/}
...
## MUMPS Method description
 ...
 Code | ```  D GETTD^ORWTPN(.VALUE,CLASS,DUZ)```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}