...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | GMVX | LITERAL | 50 | true | This value is the name of the file and the date/time associated with it (e.g., GMV_VITALSVIEWENTER.DLL:v. 07/21/05 10:34). | 