...
| {::nomarkdown}DATA{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}40{:/} | {::nomarkdown}true{:/} | {::nomarkdown}|TAB|; DATA : |TAB|;  LVIEW =Piece 1 |TAB|;     +LVIEW = 1  :  |TAB|;          result array is formatted for a magListView control|TAB|;              i.e.  ^ delimiter for data and \|\ delimiter for IEN|TAB|;     +LVIEW = 0  : |TAB|;         old way,  \  \ delim for data and '^' delim for IEN|TAB|;  INDX = Piece 2|TAB|;                       This is the index to search |TAB|;                       Defaults to \B\{:/} | 
