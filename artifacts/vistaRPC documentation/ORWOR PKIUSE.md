...
## MUMPS Method description
 ...
 Code | ```  N ORPKIU<br/> S RETURN=0<br/> S ORPKIU=0 I $D(^ORD(100.7,"C",DUZ)) S ORPKIU=1<br/> I ORPKIU S RETURN=1```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}