...
# [RPCs](TableOfContent.md) &#8594; DENTV TP CODE CHECKS 
...
| {::nomarkdown}DATA{:/} | {::nomarkdown}LIST{:/} | {::nomarkdown}10{:/} | {::nomarkdown}true{:/} | {::nomarkdown}Contains an array of the current session's completed procedures as DATA(n)=ADA Code{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}