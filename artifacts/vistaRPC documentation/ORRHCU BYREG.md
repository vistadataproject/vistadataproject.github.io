...
# [RPCs](TableOfContent.md) &#8594; ORRHCU BYREG 
...
| {::nomarkdown}MOD{:/} | {::nomarkdown}LITERAL{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown}The mode by which the registry should be accessed (active, inactive, both).{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}