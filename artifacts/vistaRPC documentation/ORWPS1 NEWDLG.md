...
## MUMPS Method description
 ...
 Code | ```  N DGRP,ID,IEN,TXT,TYP,X,X0,X5<br/> I INPAT S X=$$GET^XPAR("ALL","ORWDX NEW MED","i","I")<br/> E  S X=$$GET^XPAR("ALL","ORWDX NEW MED","o","I")<br/> S IEN=+X,X0=$G(^ORD(101.41,IEN,0)),X5=$G(^(5))<br/> S TYP=$P(X0,U,4),DGRP=+$P(X0,U,5),ID=+$P(X5,U,5),TXT=$P(X5,U,4)<br/> S Y=IEN_";"_ID_";"_DGRP_";"_TYP_U_TXT```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}