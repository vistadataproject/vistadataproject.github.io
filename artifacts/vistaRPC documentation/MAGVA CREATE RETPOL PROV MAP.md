...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}MAGPARAM{:/} | {::nomarkdown}LIST{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown} MAGPARAM(\RETENTION POLICY\) = Pointer to RETENTION POLICY file (#2006.914) MAGPARAM(\STORAGE PROVIDER\) = Pointer to STORAGE PROVIDER file (#2006.917) MAGPARAM(\SOURCE PLACE\) = Pointer to IMAGING SITE PARAMETERS file (#2006.1) MAGPARAM(\SYNCHRONOUS\) = 0/1 MAGPARAM(\OFFSITE\) = 0/1{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}