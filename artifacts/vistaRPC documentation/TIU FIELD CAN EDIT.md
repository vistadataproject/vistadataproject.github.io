...
## MUMPS Method description
 ...
 Code | ```  S TIUY=0<br/> I '+DUZ Q<br/> N TIUCLASS,TIUERR,IDX,SRV<br/> S SRV=$P($G(^VA(200,DUZ,5)),U)<br/> D GETLST^XPAR(.TIUCLASS,DUZ_";VA(200,^SRV.`"_+$G(SRV)_"^DIV^SYS^PKG","TIU FIELD EDITOR CLASSES","Q",.TIUERR)<br/> I TIUERR>0 Q<br/> S IDX=0<br/> F  S IDX=$O(TIUCLASS(IDX)) Q:'IDX  D  Q:+TIUY<br/> .I $$ISA^USRLM(DUZ,$P(TIUCLASS(IDX),U,2),.TIUERR) S TIUY=1```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}