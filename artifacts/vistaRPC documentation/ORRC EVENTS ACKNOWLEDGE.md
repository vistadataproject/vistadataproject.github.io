...
| {::nomarkdown}ALERTS{:/} | {::nomarkdown}LIST{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown}This is the list of alert IDs to be cleared, in the form \VST:\_ID whereID is the alert identifier as defined by Kernel (\OR,<patient>,<Notification ien>;<creator>;<date created>\).{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}