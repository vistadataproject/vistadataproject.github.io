...
# [RPCs](TableOfContent.md) &#8594; SC PAT ASGN MAILMAN 
...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}VALUE{:/} | {::nomarkdown}LITERAL{:/} | {::nomarkdown}512{:/} | {::nomarkdown}true{:/} |  | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}