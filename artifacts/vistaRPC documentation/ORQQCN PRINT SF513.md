...
## MUMPS Method description
 ...
 Code | ```  N ORSTATUS<br/> D EN^GMRCP5(GMRCO,GMRCCHT,GMRCDEV,.ORSTATUS)<br/> S Y=ORSTATUS```{::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:24 am</p>{:/}