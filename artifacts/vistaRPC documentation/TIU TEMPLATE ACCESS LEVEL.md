...
### MUMPS Method description
 ...
 First comment | {::nomarkdown}<br/>Return Values:<br/><br/> 0 = FULL ACCESS<br/> 1 = READ ONLY<br/> 2 = NO ACCESS<br/> 3 = SHARED TEMPLATES EDITOR - ACCESS PARAMETERS DO NOT APPLY<br/>{:/}
