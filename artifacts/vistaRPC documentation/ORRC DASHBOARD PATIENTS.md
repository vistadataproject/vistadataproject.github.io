...
# [RPCs](TableOfContent.md) &#8594; ORRC DASHBOARD PATIENTS 
...
| {::nomarkdown}TYPE{:/} | {::nomarkdown}LITERAL{:/} |  | {::nomarkdown}true{:/} | {::nomarkdown}This is the type of dashboard view desired, (C)linician or (N)urse.{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}