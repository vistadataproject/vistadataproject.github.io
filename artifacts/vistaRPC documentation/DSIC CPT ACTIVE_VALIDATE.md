...
| --- | --- | --- | --- | --- | --- | 
| vs:Input_Parameter-8994_02 | CODE | LITERAL | 7 | true | This is the CPT, HCPCS, or level III code from file 81 in either internal or external format. | 
...
| vs:Input_Parameter-8994_02 | SRC | LITERAL | 1 | true | This boolean flag (1 or 0) indicates whether or not Level III codes should be screened out.  If SCR=1 then allow Level III codes.  Default value is 0. | 