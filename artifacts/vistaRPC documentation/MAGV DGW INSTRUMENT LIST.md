...
| --- | --- | --- | --- | --- | 
| {::nomarkdown}HOSTNAME{:/} | {::nomarkdown}LITERAL{:/} |  |  | {::nomarkdown}The HOSTNAME is the corresponding DICOM Gateway.  If HOSTNAME is blank all settings will be returned{:/} | {::nomarkdown} <br/><br/><p style="font-size: 11px">Generated on January 14th 2017, 7:36:25 am</p>{:/}