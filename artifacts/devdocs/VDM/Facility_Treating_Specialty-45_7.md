...
**Specialty**{::nomarkdown}<pre><code>  specialty</code></pre>{:/} | 1 | This field contains the treating specialty name as entered by<br/>facility or distributed with software.  Pointer to  Specialty File | POINTER | INDEXED<br/>REQUIRED | Specialty-42_4
