...
**Last Batch Transmitted**{::nomarkdown}<pre><code>  last_batch_transmitted</code></pre>{:/} | 6 | The batch number of the last completed transmission. | POINTER |  | [Cmop_Transmission-550_2](Cmop_Transmission-550_2)
