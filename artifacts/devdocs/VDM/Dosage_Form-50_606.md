...
## [VDM](TableOfContents) &#8594; Dosage_Form-50_606
# Dosage Form (50.606)
This file contains dosage forms.

<dl>
<dt>Global</dt><dd>^PS(50.606,</dd>
...
### Subfile
#### <a name="Noun-50_6066"></a>Noun

<dl>
<dt>ID</dt><dd>Noun-50_6066</dd>
<dt>File Type</dt><dd>50.6066</dd>
<dt>Label</dt><dd>Noun</dd></dl>
...
#### <a name="Units-50_6068"></a>Units

<dl>
<dt>ID</dt><dd>Units-50_6068</dd>
<dt>File Type</dt><dd>50.6068</dd>
<dt>Label</dt><dd>Units</dd></dl>

#### Properties

Field | ID | Description | Datatype | Attributes | Range
--- | --- | --- | --- | --- | ---
**Units**{::nomarkdown}<pre><code>  units</code></pre>{:/} | .01 | Unit of measure. Pointer to the Drug Units File #50.607. | POINTER | INDEXED<br/>REQUIRED | [Drug_Units-50_607](Drug_Units-50_607)
...
#### <a name="Dispense_Units_Per_Dose-50_6069"></a>Dispense Units Per Dose
