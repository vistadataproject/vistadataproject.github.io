...
**Object Of Order**{::nomarkdown}<pre><code>  object_of_order</code></pre>{:/} | .02 | This is the individual object of the order.  Depending on the parent <br/>file entry, this would be the Patient, Control Point, etc. | POINTER | REQUIRED | [Patient-2](Patient-2)<br/>[Referral_Patient-67](Referral_Patient-67)
...
**Event**{::nomarkdown}<pre><code>  event</code></pre>{:/} | 15 | This is the event that this order's release is/was delayed till. | POINTER |  | [Oe_rr_Patient_Event-100_2](Oe_rr_Patient_Event-100_2)
...
**Dc Event**{::nomarkdown}<pre><code>  dc_event</code></pre>{:/} | 68 | This is the event that automatically discontinued this order. | POINTER |  | [Oe_rr_Patient_Event-100_2](Oe_rr_Patient_Event-100_2)
...
**Bulletin**{::nomarkdown}<pre><code>  bulletin</code></pre>{:/} | 32 | This is the bulletin sent as a result of flagging this order. | POINTER |  | [Message-3_9](Message-3_9)
