...
**Default Urgency**{::nomarkdown}<pre><code>  default_urgency</code></pre>{:/} | 301 | The urgency that will be used as the default choice, usually Routine. | POINTER | REQUIRED | Urgency-62_05
