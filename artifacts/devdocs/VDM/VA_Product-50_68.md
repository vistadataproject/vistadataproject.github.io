...
**Units**{::nomarkdown}<pre><code>  units</code></pre>{:/} | 3 | This is the unit of measure. | POINTER |  | Drug_Units-50_607
...
**VA Dispense Unit**{::nomarkdown}<pre><code>  va_dispense_unit</code></pre>{:/} | 8 | This is the VA Dispense Unit. | POINTER |  | VA_Dispense_Unit-50_64
...
**Units**{::nomarkdown}<pre><code>  units</code></pre>{:/} | 2 | This is the unit of measure. | POINTER |  | Drug_Units-50_607
