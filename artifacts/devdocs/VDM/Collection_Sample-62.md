...
**Lab Section**{::nomarkdown}<pre><code>  lab_section</code></pre>{:/} | 6 | The functional section of the lab that this sample is associated with.<br/>Points to FILE #62.2. | POINTER |  | Lab_Section-62_2
...
Label/Field Name | Field # | Description | Datatype | Attributes | Range
--- | --- | --- | --- | --- | ---
**Wkld Code**{::nomarkdown}<pre><code>  wkld_code</code></pre>{:/} | .01 |  Enter the WKLD code for thi | POINTER | REQUIRED | Wkld_Code-64
