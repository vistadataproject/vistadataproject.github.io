...
**Server Bulletin**{::nomarkdown}<pre><code>  server_bulletin</code></pre>{:/} | 220 |  <br/>This field may contain a pointer to the bulletin which will override the<br/>default bulletin XQSERVER for a server-type option.  This bulletin will be<br/>usedto notify the users in the event of a security breach, etc. | POINTER |  | [Bulletin-3_6](Bulletin-3_6)
