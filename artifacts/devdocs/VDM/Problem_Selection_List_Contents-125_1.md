...
**Category**{::nomarkdown}<pre><code>  category</code></pre>{:/} | 2 | This is the category whose problem items are to be included in the current<br/>list; it may have a subheader in this list, and a designated order. | POINTER | INDEXED | [Problem_Selection_Category-125_11](Problem_Selection_Category-125_11)
