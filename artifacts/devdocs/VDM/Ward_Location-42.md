...
**Reason**{::nomarkdown}<pre><code>  reason</code></pre>{:/} | .02 | Enter the reason this ward (or part of a ward) was placed out of service.<br/>This is a pointer to the MAS OUT-OF-SERVICE file.  These reasons are<br/>determined by MAS VACO. | POINTER | REQUIRED | Mas_Outofservice-405_5
