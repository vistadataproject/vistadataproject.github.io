...
Label/Field Name | Field # | Description | Datatype | Attributes | Range
--- | --- | --- | --- | --- | ---
**Autolink**{::nomarkdown}<pre><code>  autolink</code></pre>{:/} | .01 | Links for automatic patient addition/removal based on ADT movements and<br/>CLINIC enrollments. | POINTER | INDEXED<br/>REQUIRED | [Ward_Location-42](Ward_Location-42)<br/>Roombed-405_4<br/>[New_Person-200](New_Person-200)<br/>[Facility_Treating_Specialty-45_7](Facility_Treating_Specialty-45_7)<br/>[Hospital_Location-44](Hospital_Location-44)
