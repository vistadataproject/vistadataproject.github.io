...
**Report Component**{::nomarkdown}<pre><code>  report_component</code></pre>{:/} | .192 | This is the report component associated with this report. | POINTER |  | Health_Summary_Component-142_1
