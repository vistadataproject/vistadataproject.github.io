...
**A Privilege**{::nomarkdown}<pre><code>  a_privilege</code></pre>{:/} | 8 | If not null, only those users holding the specified key can administer the<br/>instrument. | POINTER |  | [Security_Key-19_1](Security_Key-19_1)
