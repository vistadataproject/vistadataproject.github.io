...
**Ledi Hl7**{::nomarkdown}<pre><code>  ledi_hl7</code></pre>{:/} | .09 | This field contains the HL7 standard specimen type code. | POINTER |  | Lab_Electronic_Codes-64_061
...
**Medical Journal**{::nomarkdown}<pre><code>  medical_journal</code></pre>{:/} | 2 | The name of the medical journal containing the article.  Points to FILE #95. | POINTER |  | Lab_Journal-95
