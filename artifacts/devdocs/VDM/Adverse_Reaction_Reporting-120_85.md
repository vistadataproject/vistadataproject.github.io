...
**Reporter State**{::nomarkdown}<pre><code>  reporter_state</code></pre>{:/} | 48 | The state where the reporter resides. | POINTER |  | State-5
...
**Mfr State**{::nomarkdown}<pre><code>  mfr_state</code></pre>{:/} | 58 | This is the state where the manufacturer is located. | POINTER |  | State-5
