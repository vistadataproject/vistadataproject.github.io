...
--- | --- | --- | --- | --- | ---
**Category**{::nomarkdown}<pre><code>  category</code></pre>{:/} | .01 | This is the problem category that this problem entry belongs to. | POINTER | INDEXED<br/>REQUIRED | Problem_Selection_Category-125_11
