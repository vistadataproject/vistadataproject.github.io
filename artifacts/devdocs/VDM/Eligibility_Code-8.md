...
**Agency**{::nomarkdown}<pre><code>  agency</code></pre>{:/} | 11 | This field contains the AGENCY that is associated with this <br/>eligibility.  Normally,the agency is the VA. | POINTER |  | Agency-4_11
