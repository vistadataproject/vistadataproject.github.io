...
**Classification Source**{::nomarkdown}<pre><code>  classification_source</code></pre>{:/} | 2 | Pointer to the classification system (ICD/CPT/DSM etc) described in the<br/>Coding Systems file (#757.03) from which the code (field 1) is derived. | POINTER | REQUIRED | Coding_Systems-757_03
