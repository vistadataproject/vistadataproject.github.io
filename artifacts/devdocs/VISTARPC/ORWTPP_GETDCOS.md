...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP GETDCOS<br/>
# ORWTPP GETDCOS
...
Method Comment | RPC
First Comment | {::nomarkdown}<pre><code> get default cosigner for current user</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D GETDCOS^ORWTPN(.VALUE,DUZ)</code></pre>{:/}
