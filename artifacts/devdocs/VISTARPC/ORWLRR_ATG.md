...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR ATG<br/>
# ORWLRR ATG
...
Input Parameters | TESTGP, USER
Code | {::nomarkdown}<pre><code> D ATG^LR7OGO(.ORY,TESTGP,USER)</code></pre>{:/}
