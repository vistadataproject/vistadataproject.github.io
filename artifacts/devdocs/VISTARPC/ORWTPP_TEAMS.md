...
## [VISTA RPCs](TableOfContents) &#8594; ORWTPP TEAMS
# ORWTPP TEAMS
...
Property | Value
--- | ---
Method | [TEAMS^ORWTPP](http://code.osehra.org/dox/Routine_ORWTPP_source.html)
Method Comment | RPC
First Comment | {::nomarkdown}<pre><code> get teams for current user</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D TEAMS^ORWTPT(.VALUES,DUZ)</code></pre>{:/}
