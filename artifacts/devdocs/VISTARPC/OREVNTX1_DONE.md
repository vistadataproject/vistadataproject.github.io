...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; OREVNTX1 DONE<br/>
# OREVNTX1 DONE
...
Code | {::nomarkdown}<pre><code> Q:'PTEVT<br/> D DONE^OREVNTX(PTEVT)<br/> D ACTLOG^OREVNTX(PTEVT,"MN")</code></pre>{:/}
