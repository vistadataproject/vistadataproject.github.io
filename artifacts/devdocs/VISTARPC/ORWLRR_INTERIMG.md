...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR INTERIMG<br/>
# ORWLRR INTERIMG
...
Input Parameters | DFN, DATE1, DIR, FORMAT
Code | {::nomarkdown}<pre><code> D INTERIMG^LR7OGM(.ORY,DFN,DATE1,DIR,$G(FORMAT,1))</code></pre>{:/}
