...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC LOOKUP<br/>
# ORWGRPC LOOKUP
...
Input Parameters | INFO, FROM, DIR
Code | {::nomarkdown}<pre><code> D LOOKUP^ORWGAPI(.VAL,INFO,.FROM,DIR)</code></pre>{:/}
