...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC GETDATES<br/>
# ORWGRPC GETDATES
...
Code | {::nomarkdown}<pre><code> D GETDATES^ORWGAPI("ORWGRPC",$G(REPORTID))<br/> S DATA=$NA(^TMP("ORWGRPC",$J))</code></pre>{:/}
