...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWDAL32 SITE PARAMS<br/>
...
Code | {::nomarkdown}<pre><code> N GMRASITE<br/> D SITE^GMRAUTL<br/> S ORY=$G(^GMRD(120.84,GMRASITE,0))</code></pre>{:/}
