...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR INTERIMS<br/>
# ORWLRR INTERIMS
...
Input Parameters | DFN, DATE1, DATE2, ORTESTS
Code | {::nomarkdown}<pre><code> D INTERIMS^LR7OGM(.ORY,DFN,DATE1,DATE2,.ORTESTS)</code></pre>{:/}
