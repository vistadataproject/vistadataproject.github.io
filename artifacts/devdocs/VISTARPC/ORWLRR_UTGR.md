...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR UTGR<br/>
# ORWLRR UTGR
...
Input Parameters | ORTESTS, TGRP
Code | {::nomarkdown}<pre><code> D UTGR^LR7OGO(.ORY,.ORTESTS,TGRP)</code></pre>{:/}
