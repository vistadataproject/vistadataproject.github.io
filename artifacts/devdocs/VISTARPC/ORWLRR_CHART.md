...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR CHART<br/>
# ORWLRR CHART
...
Input Parameters | DFN, DATE1, DATE2, SPEC, TEST
Code | {::nomarkdown}<pre><code> D CHART^LR7OGC(.ORY,DFN,DATE1,DATE2,SPEC,TEST)</code></pre>{:/}
