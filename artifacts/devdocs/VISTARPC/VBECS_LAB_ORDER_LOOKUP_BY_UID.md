...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; VBECS LAB ORDER LOOKUP BY UID<br/>
...
--- | ---
Label | ORDER
MUMPS Implementation | [VBECRPCB](http://code.osehra.org/dox/Routine_VBECRPCB_source.html)
