...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; OREVNTX1 LOC<br/>
# OREVNTX1 LOC
...
Code | {::nomarkdown}<pre><code> Q:'+PTEVT<br/> S ORY=$$LOC^OREVNTX(PTEVT)<br/> S ORY=+ORY</code></pre>{:/}
