...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC CLASS<br/>
# ORWGRPC CLASS
...
Code | {::nomarkdown}<pre><code> D CLASS^ORWGAPI("ORWGRPC",TYPE)<br/> S DATA=$NA(^TMP("ORWGRPC",$J))</code></pre>{:/}
