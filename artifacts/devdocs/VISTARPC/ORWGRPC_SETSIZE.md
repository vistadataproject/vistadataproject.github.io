...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC SETSIZE<br/>
# ORWGRPC SETSIZE
...
Code | {::nomarkdown}<pre><code> D SETSIZE^ORWGAPI("ORWGRPC",.VAL)<br/> S ERR=$NA(^TMP("ORWGRPC",$J))</code></pre>{:/}
