...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; TIU GET PN TITLES<br/>
# TIU GET PN TITLES
...
Property | Value
--- | ---
Method | [NOTES^TIUSRVD](http://code.osehra.org/dox/Routine_TIUSRVD_source.html)
Method Comment | Get list of PN Titles
Code | {::nomarkdown}<pre><code> D LIST(.TIUY,3)</code></pre>{:/}
