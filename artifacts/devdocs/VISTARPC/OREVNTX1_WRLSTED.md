...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; OREVNTX1 WRLSTED<br/>
# OREVNTX1 WRLSTED
...
Input Parameters | LOC, EVTID
First Comment | {::nomarkdown}<pre><code> .Y(n): DlgName^ListBox Text</code></pre>{:/}
