...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR UTGA<br/>
# ORWLRR UTGA
...
Property | Value
--- | ---
Method | [UTGA^ORWLRR](http://code.osehra.org/dox/Routine_ORWLRR_source.html)
Method Comment | from Remote Procedure file
Input Parameters | ORTESTS
Code | {::nomarkdown}<pre><code> D UTGA^LR7OGO(.ORY,.ORTESTS)</code></pre>{:/}
