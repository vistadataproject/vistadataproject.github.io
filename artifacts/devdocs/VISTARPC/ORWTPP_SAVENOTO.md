...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP SAVENOTO<br/>
# ORWTPP SAVENOTO
...
First Comment | {::nomarkdown}<pre><code> save current user's notification info</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D SAVENOTO^ORWTPR(.OK,INFO,DUZ)</code></pre>{:/}
