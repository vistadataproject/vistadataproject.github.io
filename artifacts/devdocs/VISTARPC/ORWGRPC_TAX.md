...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC TAX<br/>
# ORWGRPC TAX
...
Input Parameters | ALL, REMTAX
Code | {::nomarkdown}<pre><code> D TAX^ORWGAPI("ORWGRPC",+$G(ALL),.REMTAX)<br/> S DATA=$NA(^TMP("ORWGRPC",$J))</code></pre>{:/}
