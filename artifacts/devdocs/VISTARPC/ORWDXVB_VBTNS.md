...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWDXVB VBTNS<br/>
# ORWDXVB VBTNS
...
Code | {::nomarkdown}<pre><code> S RETURN=$$GET^XPAR("ALL","ORWDXVB VBECS TNS CHECK",1,"I")</code></pre>{:/}
