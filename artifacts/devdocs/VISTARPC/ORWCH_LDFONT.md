...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWCH LDFONT<br/>
# ORWCH LDFONT
...
Code | {::nomarkdown}<pre><code> S VAL=$$GET^XPAR(DUZ_";VA(200,","ORWCH FONT SIZE",1,"I")</code></pre>{:/}
