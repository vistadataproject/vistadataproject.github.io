...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; GMV LOCATION SELECT<br/>
# GMV LOCATION SELECT
...
--- | ---
Label | RPC
MUMPS Implementation | [GMVRPCHL](http://code.osehra.org/dox/Routine_GMVRPCHL_source.html)
