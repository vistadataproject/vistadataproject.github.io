...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP SETCOMBO<br/>
# ORWTPP SETCOMBO
...
First Comment | {::nomarkdown}<pre><code> set current user's combo list definition</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D SETCOMBO^ORWTPT(.OK,.VALUES,DUZ)<br/></code></pre>{:/}
