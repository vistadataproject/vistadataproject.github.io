...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC FASTTASK<br/>
# ORWGRPC FASTTASK
...
Input Parameters | DFN, OLDDFN
Code | {::nomarkdown}<pre><code> D FASTTASK^ORWGAPI(.STATUS,DFN,$G(OLDDFN))</code></pre>{:/}
