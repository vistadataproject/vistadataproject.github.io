...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR PARAM<br/>
# ORWLRR PARAM
...
Property | Value
--- | ---
Method | [PARAM^ORWLRR](http://code.osehra.org/dox/Routine_ORWLRR_source.html)
Method Comment | from Remote Procedure file
Code | {::nomarkdown}<pre><code> D PARAM^LR7OGO(.ORY)</code></pre>{:/}
