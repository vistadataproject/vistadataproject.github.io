...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP CSLAB<br/>
# ORWTPP CSLAB
...
Method Comment | RPC
First Comment | {::nomarkdown}<pre><code> get lab date range defaults</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D CSLAB^ORWTPO(.INFO,DUZ)</code></pre>{:/}
