...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC DELVIEWS<br/>
# ORWGRPC DELVIEWS
...
Input Parameters | NAME, PUBLIC
Code | {::nomarkdown}<pre><code> D DELVIEWS^ORWGAPI("ORWGRPC",NAME,+$G(PUBLIC))<br/> S ERR=$NA(^TMP("ORWGRPC",$J))</code></pre>{:/}
