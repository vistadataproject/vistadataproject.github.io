...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWDRA32 ISOLATN<br/>
# ORWDRA32 ISOLATN
...
Code | {::nomarkdown}<pre><code> N ORVP<br/> S ORVP=DFN_";DPT("<br/> S Y=$$IP^ORMBLD</code></pre>{:/}
