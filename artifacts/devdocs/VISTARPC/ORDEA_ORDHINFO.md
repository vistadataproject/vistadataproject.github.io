...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORDEA ORDHINFO<br/>
# ORDEA ORDHINFO
...
Input Parameters | ORIFN, HASH, OHINFO
Code | {::nomarkdown}<pre><code> N IENS<br/> D BUILDFDA(ORIFN,.ORDFDA,.ORY,$G(HASH),.OHINFO)</code></pre>{:/}
