...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; DSIRRPTF FOIA YEAR END REPORT<br/>
...
--- | ---
Label | FOIA
MUMPS Implementation | [DSIRRPTF](http://code.osehra.org/dox/Routine_DSIRRPTF_source.html)
