...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP SETREM<br/>
# ORWTPP SETREM
...
First Comment | {::nomarkdown}<pre><code> set current user's reminders</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D SETREM^ORWTPR(.OK,.VALUES,DUZ)</code></pre>{:/}
