...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWLRR USERS<br/>
# ORWLRR USERS
...
Property | Value
--- | ---
Method | [USERS^ORWLRR](http://code.osehra.org/dox/Routine_ORWLRR_source.html)
Method Comment | from Remote Procedure file
Input Parameters | FROM, DIR
Code | {::nomarkdown}<pre><code> D USERS^LR7OGO(.ORY,FROM,DIR)</code></pre>{:/}
