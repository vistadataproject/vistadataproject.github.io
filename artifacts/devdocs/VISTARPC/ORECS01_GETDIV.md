...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORECS01 GETDIV<br/>
# ORECS01 GETDIV
...
Input Parameters | USR
Code | {::nomarkdown}<pre><code> S ORY=0<br/> S:$G(DUZ(2)) ORY=DUZ(2)</code></pre>{:/}
