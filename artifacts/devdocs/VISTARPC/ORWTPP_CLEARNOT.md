...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP CLEARNOT<br/>
# ORWTPP CLEARNOT
...
Method Comment | RPC
First Comment | {::nomarkdown}<pre><code> clear current user's notifications</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D CLEARNOT^ORWTPR(.OK,DUZ)</code></pre>{:/}
