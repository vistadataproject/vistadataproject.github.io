...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; OREVNTX1 NAME<br/>
# OREVNTX1 NAME
...
Code | {::nomarkdown}<pre><code> I PTEVT'>0 S ORY="" Q<br/> S ORY=$$NAME^OREVNTX(PTEVT)</code></pre>{:/}
