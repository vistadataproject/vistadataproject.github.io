...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWGRPC TESTSPEC<br/>
# ORWGRPC TESTSPEC
...
Code | {::nomarkdown}<pre><code> D TESTSPEC^ORWGAPI("ORWGRPC")<br/> S DATA=$NA(^TMP("ORWGRPC",$J))</code></pre>{:/}
