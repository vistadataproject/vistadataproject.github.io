...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; MAG3 TELEREADER CPT CODELOOKUP<br/>
...
--- | ---
Label | CPTFIND
MUMPS Implementation | [MAGNTLR7](http://code.osehra.org/dox/Routine_MAGNTLR7_source.html)
Return Type | ARRAY
...
--- | --- | --- | --- | ---
MAGFIND | LITERAL |  | true | Look up CPT code description value.
