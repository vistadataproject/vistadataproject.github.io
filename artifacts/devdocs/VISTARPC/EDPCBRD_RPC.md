...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; EDPCBRD RPC<br/>
# EDPCBRD RPC
...
--- | ---
Label | RPC
MUMPS Implementation | [EDPCBRD](http://code.osehra.org/dox/Routine_EDPCBRD_source.html)
Return Type | ARRAY
