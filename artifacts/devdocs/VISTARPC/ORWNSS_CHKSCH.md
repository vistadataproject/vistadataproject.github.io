...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWNSS CHKSCH<br/>
# ORWNSS CHKSCH
...
Input Parameters | SCH
Code | {::nomarkdown}<pre><code> Q:SCH=""<br/> D VALSCH^ORWDPS33(.ORY,SCH,"I")<br/></code></pre>{:/}
