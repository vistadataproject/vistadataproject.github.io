...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP SAVELIST<br/>
# ORWTPP SAVELIST
...
Method Comment | RPC
Input Parameters | PLIST, LISTNUM, ORVIZ
First Comment | {::nomarkdown}<pre><code> save current user's personal list changes</code></pre>{:/}
Code | {::nomarkdown}<pre><code> D SAVELIST^ORWTPL(.OK,.PLIST,LISTNUM,DUZ,$G(ORVIZ))</code></pre>{:/}
