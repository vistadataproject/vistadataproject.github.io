...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; ORWTPP CHKSURR<br/>
# ORWTPP CHKSURR
...
Method Comment | RPC
Input Parameters | SURR
First Comment | {::nomarkdown}<pre><code> check if current user's surrogate is valid</code></pre>{:/}
Code | {::nomarkdown}<pre><code> S OK=$$CHKSURR^ORWTPUA(DUZ,SURR)</code></pre>{:/}
