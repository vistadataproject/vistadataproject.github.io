...
#### [Developer Documentation](../index) &#187; [Native RPCs](TableOfContents) &#187; OREVNTX1 PUTEVNT<br/>
# OREVNTX1 PUTEVNT
...
Input Parameters | DFN, EVT, ORIFN
Code | {::nomarkdown}<pre><code> S ORY=$$NEW^OREVNT(DFN,EVT,ORIFN)</code></pre>{:/}
