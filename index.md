...
The 130 VISTA systems in operation today encompass over three decades of VA- and Veteran-specific know-how and data, including over three hundred million veteran-years of health data, and continues to grow at the rate of over a million new clinical documents, lab tests, and radiographs each day. The [VHA Records Control Schedule](https://www.va.gov/vhapublications/rcs10/rcs10-1.pdf) (Section 6000.2b, page 185) mandates that __the veterans complete electronic health record must be accessible in digital form for 75 years__.  It is thus necessary to future-proof access to VISTA's data to support continuity of veteran care now, and for many decades into the future.
