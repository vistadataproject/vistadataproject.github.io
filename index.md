...
The 130 VISTA systems in operation today contain over three hundred million veteran-years of health data, and continue to grow at the rate of over a million new clinical documents, lab tests, and radiographs each day. Government policy mandates the __complete veterans electronic health record must be available in digital form for 75 years after the last episode of care__. (VA Records Retention Schedule,Section 6000.2(b) [here](https://www.va.gov/vhapublications/rcs10/rcs10-1.pdf)). Given that VA already has nearly forty years of veteran data in VISTA, even if the last episode of care were tomorrow, VA would need to maintain VISTA's data in digital computable form for well over 100 years.  It is thus necessary to assure comprehensive, future-proof access to VISTA's data to provide continuity of veteran care now, and well into the next century.
