...
The 130 VISTA systems in operation today contain over three hundred million veteran-years of health data, and continue to grow at the rate of over a million new clinical documents, lab tests, and radiographs each day. The [VHA Records Control Schedule](https://www.va.gov/vhapublications/rcs10/rcs10-1.pdf) (Section 6000.2b) mandates the __veterans complete electronic health record must be available for 75 years__.  It thus necessary to assure modern, comprehensive access to VISTA's data to provide continuity of veteran care now, and for decades into the future.  
