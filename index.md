...
The VISTA Data Model (VDM) is in turn normalized across all local VISTA system data models to create a national, standardized __Master VISTA Data Model__ (MVDM), alowing  transactions across all VA VISTA systems with a single, standard, secure, service-based mechanism, __MVDM Services__: 
