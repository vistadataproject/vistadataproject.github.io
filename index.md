...
The 130 VISTA systems in operation today contain over three hundred million veteran-years of health data, and continues to grow at the rate of over a million new clinical documents, lab tests, and radiographs each day.  The [VA Records Retention Schedule](https://www.va.gov/vhapublications/rcs10/rcs10-1.pdf) (see Section 6000.2b) mandates that the __veterans complete health record must be available in digital form for 75 years__ after the last episode of care.  Comprehensive, future-proof access to VISTA data is thus necessary to provide continuity of veteran care now, and for many decades into the future.  
