...
The 130 VISTA systems in operation today contain over three hundred million veteran-years of health data, and continue to grow at the rate of over a million new clinical documents, lab tests, and radiographs each day. The VA's Records Retention Schedule ([Section 6000.2(b)](https://www.va.gov/vhapublications/rcs10/rcs10-1.pdf)) mandates that the veterans __complete health record must be available in digital form for 75 years after the last episode of care__.  Thus comprehensive, future-proof access to VISTA data is required provide this continuity of veteran care now, and for many decades into the future.
