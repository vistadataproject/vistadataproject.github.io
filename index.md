...
The 130 VISTA systems in operation today encompass over three decades of VA- and Veteran-specific know-how and data, including over three hundred million veteran-years of health data, and continues to grow at the rate of over a million new clinical documents, lab tests, and radiographs each day. The [VA Records Control Schedule](https://www.va.gov/vhapublications/rcs10/rcs10-1.pdf) (page 185, Section 6000.2b) reqires *__the veterans electronic health record must be accessible for 75 years__*.  It is thus necessary to future-proof access to VISTA's data to support continuity of veteran care now, and for many decades into the future.
