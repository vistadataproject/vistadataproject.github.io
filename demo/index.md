...
If one wishes to run CPRS on MacOS or LinuxOS, one first needs to create a Windows virtual environment using either the free open-source [Virtualbox](https://www.virtualbox.org) or commercial [VMWare](http://www.vmware.com/products/fusion.html) hypervisors, and then install the free  [Windows 10 image](https://www.microsoft.com/en-us/software-download/windows10ISO) within this hypervisor. Alternately, Microsoft offers pre-built, virtualized versions of Windows OS for several hosted hypervisors. [https://developer.microsoft.com/en-us/microsoft-edge/tools/vms/#downloads](https://developer.microsoft.com/en-us/microsoft-edge/tools/vms/#downloads). These referenced versions of Windows are free and carry some restrictions, but nothing that that affects the installation or execution of CPRS. 
