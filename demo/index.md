...
The following sections first describe how to install the nodeVISTA VM, CPRS, and then how to run the MVDM demo.<br>
__This demonstration focuses on how MVDM secures and audits existing VISTA clients such as CPRS__. 
