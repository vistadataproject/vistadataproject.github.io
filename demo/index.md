...
The Computerized Patient Record System (CPRS) is the graphical user interface (Client)  that physicians use to interact with VISTA (Server). Thus, as far as physicians and end-users are concerned, *CPRS is VISTA*.  According to the most recent national survey of over 15,000 physician end-users of EHRs ( [Medscape 2016 National EHR Survey](http://www.medscape.com/features/slideshow/public/ehr2016#page=8) ), CPRS remains one of the highest regarded integrated EHRs in the U.S.
