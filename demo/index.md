...
The Computerized Patient Record System (CPRS) is the graphical user interface (Client)  that physicians use to interact with VISTA (Server).  As far as end-users of VISTA  are concerned, CPRS is synonomous with, and indistinguishable from VISTA.
