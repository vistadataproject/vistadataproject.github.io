...
[CPRSChart30v75.zip ](http://45.33.127.157/files/CPRSChart30v75.zip) | 1. download<br>2. unzip <br>3.rename CPRSChart30v75.exe to CPRSChart.exe<br>4. copy/replace existing CPRSChart.exe in target folder | C:\Program Files (x86)\VistA\CPRS\
[CPRS30v72_dll.zip](http://45.33.127.157/files/CPRS30v72_dll.zip) | 1. download<br> 2. unzip<br> 3. copy/overwrite contents in target folder | C:\Program Files (x86)\VistA\Common Files\
