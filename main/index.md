...
![](images/vdp-vics-main-20180209v4.png)
...
* In the __Initial Operating Capability__ (IOC) phase (FY18-19) under the VistA Adaptive Maintenance (VAM) project, the Master VistA Data Model (MVDM) and its secure read-write interfaces are operationalized in a modern, secure, VA-endorsed enterprise commercial cloud (Amazon).
