...
Contents:
  ...
  * __Openly available, Git-based Software and Documentation Tagged v1.1__: [VICS Server](https://github.com/vistadataproject/VICSServer), [RPC Router](https://github.com/vistadataproject/rpcRouter) - and [Data Extract and Sync](https://github.com/vistadataproject/DataExtractNSync)
  * __[RPCs Emulated](vamB1_1RPCsEmulated)__
  * __[Build 1.1 Highlights](demo/emulation1_1)__ - four functional areas addressed in build 1.1 
  * __[Build 1.1 Demo](demo/) - upgrade to the _Coversheet Demo_ of Build 1
